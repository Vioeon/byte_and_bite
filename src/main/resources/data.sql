...
INSERT INTO post (member_id, restaurant_id, type, title, content, view_count, image, created_at) VALUES
    ...
    (1, 3, 'POST', '홍반점 솔직 후기', '양은 많은데 조금 짠 편이었어요.', 3, 'default.jpg', '2026-07-29 12:00:00'),
    (2, 1, 'POST', '진국 방문 후기', '국물이 진하고 깔끔해서 만족했습니다.', 15, 'default.jpg', '2026-07-30 10:00:00'),
    (3, 5, 'POST', '진국 설렁탕 먹어본 후기', '국물이 깊고 담백해서 해장하기 좋은 메뉴였습니다. 고기도 부드럽고 양도 충분했습니다.', 15, 'default.jpg', '2026-07-30 10:00:00'),
    (5, 2, 'POST', '파스타하우스 데이트 방문기', '매장 분위기가 좋고 크림파스타가 꾸덕하면서도 느끼하지 않아 만족스러웠습니다.', 20, 'default.jpg', '2026-07-30 11:00:00'),
    (10, 3, 'POST', '홍반점 짜장면 후기', '짜장 소스가 진하고 양이 많았습니다. 가격 대비 만족도가 높은 중식당이었습니다.', 8, 'default.jpg', '2026-07-30 12:00:00');
